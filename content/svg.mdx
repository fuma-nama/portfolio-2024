---
title: Have fun with SVG
description: Play with SVG in HTML
date: 2024-02-26T08:16:28Z
---

import { SVGButton, SVGCircle } from "../components/svg-components";

## Have fun with SVG

SVG in HTML is pretty fun. You can easily make fancy animations, visual effects with a few SVG elements.

### Gradient Border

Aside from the CSS `::after` approach, you may also use a SVG for background.

<div className="flex items-center justify-center p-4 rounded-xl border border-neutral-800 not-prose">
  <SVGButton />
</div>
...
Considering a nice banner image? It doesn't have to be an image. SVG also offers a plenty of filters, like `feTurbulence`.

<div className="rounded-xl border border-neutral-800 not-prose">
  <SVGCircle />
</div>
